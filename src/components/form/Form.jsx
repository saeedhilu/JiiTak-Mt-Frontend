...
//   });
//   console.log('All error is :', errors);

//   const togglePasswordVisibility = () => {
//     setShowPassword((prev) => !prev);
//   };
//   console.log('====================================');
//   console.log('ERror is 1233333333:',error);
//   console.log('ERror is 1233333333:',error?.response?.data?.error);
//   console.log('====================================');
...
//         {
//           notes && (
//             <h4 class="text-sm mt-4 leading-relaxed text-center">
//               {notes}
//             </h4>
...
//                     errors[field.name] ||error?.response?.data.error ? 'border-red-500' : error.includes(field.name) ? "border-red-500" : ""
//                   }`}
//                 />
//                 {field.type === "password" && (
//                   <span
...
//                 </p>
//               )}
//               {errors[field.name] || error?.response?.data.error[0] && (
//                 <p className="text-sm text-red-500 mt-1">
//                   {error.response.data.error ? error.response.data.error || error.response.data.error[0] : errors[field.name].message}
//                 </p>
//               )}
//             </div>
//           ))}
