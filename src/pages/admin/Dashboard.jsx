        ...
        <>
            ...
            <div className="bg-background pl-6 pr-6 ">
                <div className="flex flex-col  xxk2:flex-row    gap-6">
                    <div className="second flex  flex-col sm:flex-row  xxl:order-2  lg:flex-row xxk2:order-2 xxk2:flex-col  xxl:flex-row gap-6 w-full   h-44">
                        {cardData.map((card) => (
...
//                         {cardData.map((card) => (
//                             <Card key={card.id} className="flex-1 z-50">
//                                 <CardHeader>
//                                     <CardTitle>{card.title}</CardTitle>
//                                     <CardDescription>{card.text ? card.text : ""}</CardDescription>
//                                 </CardHeader>
